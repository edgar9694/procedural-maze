...
export class FirstPersonCamera {
    ...
    public objects: THREE.Object3D<THREE.Event>[] = [];
    public raycaster = new THREE.Raycaster();
    public gravity = new THREE.Raycaster(new THREE.Vector3(), new THREE.Vector3( 0, - 1, 0 ), 0, 10 );
    ...
    public sizeGrid: number;
    public blocks:  number;
    public fixCoord:  number;
